...
class _$WorkspaceEntityImpl implements _WorkspaceEntity {
  ...
  @override
  String toString() {
    return 'WorkspaceEntity(id: $id, name: $name, ownerId: $ownerId, members: $members, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _WorkspaceEntity implements WorkspaceEntity {
  const factory _WorkspaceEntity(
      ...
      required final DateTime updatedAt}) = _$WorkspaceEntityImpl;
